...
function showTab(tab) {
  ...
  // Some blocked frames expose no readable signal cross-origin. This timeout is
  // only a friendly fallback for pages that never render; it does not alter the URL.
